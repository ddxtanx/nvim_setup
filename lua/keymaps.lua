...
vim.keymap.set("n", "<leader>ta", ":lua require('telescope').extensions.vstask.tasks()<cr>", { desc = "View launch.json tasks"})
vim.keymap.set("n", "<leader>ti", ":lua require('telescope').extensions.vstask.inputs()<cr>", { desc = "View launch.json inputs"})
vim.keymap.set("n", "<leader>th", ":lua require('telescope').extensions.vstask.history()<cr>", { desc = "View launch.json task history"})
vim.keymap.set("n", "<leader>tl", ":lua require('telescope').extensions.vstask.launch()<cr>", { desc = "Launch task.json tasks"})
